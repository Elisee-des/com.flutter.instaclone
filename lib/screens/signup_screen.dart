...
import 'package:instaclone/utils/dialog.dart';
import 'package:instaclone/utils/exeption.dart';
import 'package:instaclone/utils/imagepicker.dart';
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            Textfild(username, username_F, 'Nom complet', Icons.person),
            SizedBox(height: 15.h),
            Textfild(bio, bio_F, 'bio', Icons.abc),
            SizedBox(height: 15.h),
            Textfild(password, password_F, 'Mot de passe', Icons.lock),
            SizedBox(height: 15.h),
            Textfild(passwordConfirme, passwordConfirme_F,
                'Confirmé le mot de passe', Icons.lock),
            SizedBox(height: 15.h),
            Signup(),
            SizedBox(height: 15.h),
            Have()
